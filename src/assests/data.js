export const data = [
    ...
    },
    {
        id: 2,
        title: "Phillippinies",
        desc: "The island country, the Phillippinies, is one of the most beautiful countries where blue and green are together. Forget the potion of youth, traveling to the Phillippinies will rejuvenate you for at least 5 years.",
        image:
    ...
    },
    {
        id: 6,
        title: "Paris",
        desc: "Paris has been recognized as one of the most romantic cities in the world. Many famous buildings here have been added to the Unesco Worl Heritage List. It awaits you with its museums, fashion and historical buildings.",
        image: 
    ...
    },
    {
        id: 8,
        title: "India",
        desc: "If you are not a vacationer but a traveler, we can say that India is the place for you. India, one of the most colorful places in the world, has a crazy varierty. The Taj Mahal, the story of which you have heard more or less is one of its famous buildings.",
        image: 'https://lp-cms-production.imgix.net/2020-11/GettyRF_494057771.jpg',
    },
    {
        id: 9,
        title: "Northern Lights",
        desc: "Northern Lights, the 'Aurora Borealis', named after the Dawn Goddess Aurora, are the natural glows that emerge in the sky with the interaction of the earth's magnetic field and charged particles from the Sun. This image which makes most of us feel like in a fairytale land, deserves to be visited at least once in a lifetime,",
    ...
    },
    {
        ...
        desc: "Bamboo Forest, or Arashiyama Bamboo Grove or Sagano Bamboo Forest, is a natural forset of bamboo in Arashiyama, Kyoto, Japan. The forest consists mostly of Moso Bamboo (Phyllostachys edulis) and consists of several pathways for tourists and visitors. The Ministry of the environment considers it a part of the soundscape of Japan.",
        image: 'https://wallpaperaccess.com/full/534182.jpg',
    },
    {
        id: 12,
        title: "Antelope Canyon",
        desc: "Antelope Canyon is a slot canyon in the America Southwest, on Navajo land east of page, Arizona. It includes two seperate, scenic slot canyon sections, reffered to as Upper Antelope Canyon (or The Crack), and Lower Antelope Canyon (or The Corkscrew).",
